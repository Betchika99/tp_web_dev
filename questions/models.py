...
class User(AbstractUser):
    ...
    registration_date = models.DateTimeField(default=datetime.now, verbose_name=u"Время регистрации")
    rating = models.IntegerField(default=0, verbose_name=u"Рейтинг")


class Tag(models.Model):
    title = models.CharField(max_length=70, verbose_name=u"Заголовок ярлыка")
...
class Answer(models.Model):
    ...
    author = models.ForeignKey(User, null=False, on_delete=models.CASCADE, verbose_name=u"Автор")
    create_date = models.DateTimeField(default=datetime.now, verbose_name=u"Дата написания")
